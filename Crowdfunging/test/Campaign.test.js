...
describe('Campaign',() => {
  it('deploy factory and campagin',() => {
  ...
  it('allows people to contribute and marks them as approvers', async()=>{
    ...
    const isContributer = campaign.methods.approver(accounts[1]).call();
  ...
  it('allows a manager to make a payment request', async ()=>{
    await campaign.methods.creatRequest('buy batteries','100',accounts[1])
      .send({
        from:accounts[0],
        gas:'1000000'
      });
  ...
  it('processes requests', async() => {
    ...
    await campaign.methods.
      creatRequest('A',web3.utils.toWei('5','ether'),accounts[1])
